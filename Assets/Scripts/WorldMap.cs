...
public class WorldMap : MonoBehaviour
{
		...
		void InitMeshModifier (int mapX, int mapZ, int xOffset, int zOffset)
		{
				...
				MeshModValues[] vals = {GetModValues (mapX - 1, mapZ, xOffset, zOffset),
				GetModValues (mapX - 1, mapZ - 1, xOffset, zOffset),
				GetModValues (mapX, mapZ - 1, xOffset, zOffset),
				GetModValues (mapX + 1, mapZ - 1, xOffset, zOffset),
				GetModValues (mapX + 1, mapZ, xOffset, zOffset),
				GetModValues (mapX + 1, mapZ + 1, xOffset, zOffset),
				GetModValues (mapX, mapZ + 1, xOffset, zOffset),
				GetModValues (mapX - 1, mapZ + 1, xOffset, zOffset)};
		...
		public MeshModValues GetModValues (int mapX, int mapZ, int xOffset, int zOffset)
		{
				...
				if (obj)
						return new MeshModValues (true, obj.transform.position.y, IsWater (obj));
				else
						return new MeshModValues (false, 0f, false);
		}
