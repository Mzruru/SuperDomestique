...
EZ Parallax v1.2 by TimeFloat -- now in C#!
...
A Note About the Demo Scene:
-----------------------------
The demo scene is a very quick level that I threw together, showcasing a Limbo-esque type scene to get your creative juices flowing. There are a lot of things in this demo that are NOT what you should do generally with game development in Unity. So, observe the following lists:

What You Should Do That is Exemplified in the Demo:
1. Use the EZParallax Script
2. Place your objects in 3D along the Z axis.
3. Assign all necessary objects to EZ Parallax in the Inspector for EZ Parallax.
...
What You Should *NOT* Do That is Exemplified in the Demo:
1. Have all your images as separate textures.
2. Make different materials for every different texture.
3. Use scaled Unity planes as layers for your background elements(Way more polygons than you need, and scaling isn't ideal. Try making a custom quad for it once you're ready to optimize your game.)
4. Create textures that have big ugly seams when butted up against each other, as you may notice with the fog and hills. :)
...
-------------------------
I'll be adding y axis infinite wrapping in the future as well as some other small features. Had to keep it out of this release because I've been promising the delivery of this version to the Unity store for waaaay too long. :)
...
As of 3/4/14, there aren't yet tutorial videos up for v1.1, but I'm planning on doing some tutorial videos with audio instruction in the very near future.
...
The camera lags a bit when played in the editor for some reason, but it's smooth as butter when built and running outside the editor.
